  ...
  if (!data) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <span className="text-[#8E8E93] font-semibold font-sans">ড্যাশবোর্ড লোড হচ্ছে...</span>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-[#E5E5EA] pb-4">
        <div>
          ...
          <p className="text-[#8E8E93] text-xs mt-1">পাঠাগার পরিচালনার রিয়েল-টাইম পরিমাপক পরিসংখ্যান</p>
        </div>
        <div className="flex gap-2 w-full sm:w-auto">
          ...
          <button
            onClick={onRefresh}
            className="flex items-center justify-center p-2 rounded-full bg-white border border-[#E5E5EA] hover:border-[#22242A]/30 cursor-pointer text-[#8E8E93] hover:text-[#22242A] shadow-[0_2px_8px_rgba(0,0,0,0.04)] transition-all"
            title="রিফ্রেশ করুন"
          >
            <RefreshCw size={16} />
          </button>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-6 gap-4">
        ...
        <div 
          ...
          className=" p-4 flex flex-col justify-between relative overflow-hidden group cursor-pointer"
        >
          <div className="flex justify-between items-start">
            <span className="text-[#8E8E93] text-xs font-medium">মোট বই সংখ্যা</span>
        ...
        >
          <div className="flex justify-between items-start">
            <span className="text-[#8E8E93] text-xs font-medium">Available বই</span>
        ...
        >
          <div className="flex justify-between items-start">
            <span className="text-[#8E8E93] text-xs font-medium">Issued বই</span>
        ...
        >
          <div className="flex justify-between items-start">
            <span className="text-[#8E8E93] text-xs font-medium">Late বই (Overdue)</span>
        ...
        >
          <div className="flex justify-between items-start">
            <span className="text-[#8E8E93] text-xs font-medium">আজকের লেনদেন</span>
        ...
        >
          <div className="flex justify-between items-start">
            <span className="text-[#8E8E93] text-xs font-medium">মোট সদস্য সংখ্যা</span>
        ...
        <div className=" p-6 flex flex-col">
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <p className="text-[#8E8E93] text-[11px]">বিগত ৬ মাসের বই ইস্যু এবং জমা রেকর্ডের তুলনামূলক রেখাচিত্র</p>
            </div>
            <div className="flex items-center gap-2 text-[10px] text-[#8E8E93] font-sans font-medium">
          ...
          <div className="w-full relative py-2">
            {charts.monthlyReport.length === 0 ? (
              <div className="h-40 flex items-center justify-center text-[#8E8E93] text-xs">কোনো ডাটা পাওয়া যায়নি।</div>
            ) : (
                    ...
                    {[0, 0.25, 0.5, 0.75, 1].map((ratio, i) => {
                      ...
                      return (
                        <g key={i} className="opacity-40">
                          ...
                          <text x="32" y={yVal + 3} fill="#8E8E93" fontSize="9" textAnchor="end">{num}</text>
                        </g>
                      );
                    })}
                    ...
                    {charts.monthlyReport.map((item, idx) => {
                      ...
                      return (
                        <g key={idx} className="group">
                          ...
                          {/* Label bottom */}
                          <text x={xBase} y={chartHeight - 8} fill="#8E8E93" fontSize="10" textAnchor="middle" fontWeight="600">
                            {item.month}
                          </text>
                        </g>
                      );
          ...
          <div className=" p-6 flex flex-col justify-between">
            <div>
              ...
              {charts.popularBooks.length === 0 ? (
                <p className="text-[11px] text-[#8E8E93] py-6">কোনো বুক ট্রানজেকশন হিস্ট্রি নেই।</p>
              ) : (
                    ...
                    return (
                      <div key={item.code} className="group cursor-pointer" onClick={() => onNavigate("search-smart")}>
                        <div className="flex justify-between text-xs mb-1.5">
                          ...
                          <span className="text-[#8E8E93] font-bold font-mono">{item.count} বার</span>
                        </div>
          ...
          <div className=" p-6 flex flex-col justify-between">
            <div>
              ...
              {charts.activeMembers.length === 0 ? (
                <p className="text-[11px] text-[#8E8E93] py-6">কোনো সদস্য লিজ ইতিহাস পাওয়া যায়নি।</p>
              ) : (
                <div className="space-y-4">
                  {charts.activeMembers.map((item, i) => {
                    ...
                    const pct = (item.count / topCount) * 100;
                    return (
                      <div key={item.formNumber} className="group cursor-pointer hover:bg-black/5 p-1 -mx-1 rounded" onClick={() => onNavigate("members")}>
                        <div className="flex justify-between text-xs mb-1.5">
                          <span className="font-medium text-[#22242A] truncate max-w-[120px]">{item.name}</span>
                          <span className="text-[#8E8E93] font-bold font-mono">#{item.formNumber} ({item.count})</span>
                        </div>
                        <div className="w-full h-1.5 bg-[#E5E5EA] rounded-full overflow-hidden">
                          <div
                            className="bg-[#22242A] h-full rounded-full transition-all duration-500"
      ...
      <div className=" p-6">
        <div className="flex justify-between items-center mb-4">
          <div>
            ...
            <p className="text-[#8E8E93] text-[10px] mt-1">নিচের সদস্যদের বই জমা দেওয়ার সময়সীমা অতিবাহিত হয়েছে। তাদের SMS রিকল শিডিউল সচল আছে।</p>
          </div>
          <button
            onClick={() => onNavigate("sms")}
        ...
        {charts.lateReportLoans.length === 0 ? (
          <div className="p-6 text-center text-xs text-[#8E8E93]">অসাধারণ! বর্তমানে কোনো মেয়াদোত্তীর্ণ বই পেন্ডিং নেই।</div>
        ) : (
          <div className="overflow-x-auto">
                ...
                {charts.lateReportLoans.map(item => (
                  <tr key={item.id} className="hover:bg-[#F5F3EF] duration-150">
                    <td className="py-3">
                      ...
                      <p className="text-[10px] text-[#8E8E93] font-mono mt-0.5">{item.bookCode}</p>
                    </td>
                    <td className="py-3">
                      <p className="font-bold text-[#22242A]">{item.memberName}</p>
                      <p className="text-[10px] text-[#8E8E93] font-mono mt-0.5">ফরম: #{item.formNumber}</p>
                    </td>
