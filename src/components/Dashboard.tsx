    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-6 gap-4">
        ...
        <div 
          ...
          className="glass-panel p-4 rounded-xl flex flex-col justify-between relative overflow-hidden group hover:border-cyan-500/50 hover:bg-white/[0.02] active:scale-95 cursor-pointer transition-all"
        >
          ...
          <div className="mt-4">
            ...
            <p className="text-[10px] text-cyan-400 mt-1 font-semibold group-hover:underline">তালিকা দেখুন →</p>
          </div>
        </div>
        ...
        >
          ...
          <div className="mt-4">
            ...
            <p className="text-[10px] text-emerald-400 mt-1 font-semibold group-hover:underline">তাত্ক্ষণিক লেনদেন যোগ্য →</p>
          </div>
        </div>
        ...
        <div 
          ...
          className="glass-panel p-4 rounded-xl flex flex-col justify-between relative overflow-hidden group hover:border-purple-500/50 hover:bg-white/[0.02] active:scale-95 cursor-pointer transition-all"
        >
          <div className="flex justify-between items-start">
          ...
          <div className="mt-4">
            ...
            <p className="text-[10px] text-cyan-400 mt-1 font-semibold group-hover:underline">রিটার্ন গ্রহণ করুন →</p>
          </div>
        </div>
        ...
        <div 
          ...
          className="glass-panel p-4 rounded-xl flex flex-col justify-between relative overflow-hidden group hover:border-red-500/50 hover:bg-white/[0.02] active:scale-95 cursor-pointer transition-all border-red-500/10"
        >
          <div className="flex justify-between items-start">
          ...
          <div className="mt-4">
            ...
            <p className="text-[10px] text-red-400 mt-1 font-semibold group-hover:underline">সতর্কতা প্রেরণ →</p>
          </div>
        </div>
        ...
        >
          ...
          <div className="mt-4">
            ...
            <p className="text-[10px] text-orange-400 mt-1 font-semibold group-hover:underline">লগ হিস্ট্রি →</p>
          </div>
        </div>
        ...
        >
          ...
          <div className="mt-4">
            ...
            <p className="text-[10px] text-amber-300 mt-1 font-semibold group-hover:underline">সদস্য প্যানেল →</p>
          </div>
        </div>
