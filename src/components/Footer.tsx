...
import sharifPortrait from "../assets/images/footer_sharif_portrait.png";
import booksIllustration from "../assets/images/footer_books_illustration.png";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-2 items-center">
            ...
            <div className="lg:col-span-3 flex flex-col items-center justify-center text-center">
              <div className="relative w-44 h-44 sm:w-52 sm:h-52 lg:w-56 lg:h-56 flex items-center justify-center">
                ...
                <div className="absolute bottom-6 left-2 w-3.5 h-3.5 rounded-full border-2 border-sky-300 pointer-events-none" />
                <div className="absolute top-16 -left-1 w-2.5 h-2.5 bg-rose-200 rounded-full pointer-events-none" />
                <div className="absolute bottom-12 right-2 w-3.5 h-2.5 border-2 border-violet-300 rotate-45 pointer-events-none" />
